...
export default function Edit({ c_estudante, c_cursos }) {
  const { data, setData, put, errors } = useForm({
    ...
    sexo: c_estudante.sexo || "M",
    nacionalidade: c_estudante.nacionalidade || "Moçambicana",
    periodo: c_estudante.periodo || "Laboral",
    email: c_estudante.email || "",
    contacto: c_estudante.contacto || "",
    ano_matricula: c_estudante.ano_matricula || new Date().getFullYear()
  });
  ...
  return (
    <div className="max-w-3xl mx-auto p-6 bg-white shadow-md rounded-lg mt-8">
      <h1 className="text-2xl font-bold mb-6 text-gray-800">Editar Estudante</h1>
